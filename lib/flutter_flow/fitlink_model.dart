...
Widget wrapWithModel<T extends FitLinkModel>({
  required T model,
...
T createModel<T extends FitLinkModel>(
...
abstract class FitLinkModel<W extends Widget> {
...
class FlutterFlowDynamicModels<T extends FitLinkModel> {
