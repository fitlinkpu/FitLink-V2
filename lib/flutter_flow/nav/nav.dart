...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => CreateWorkoutProfileWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/editDogProfile',
          asyncParams: {
            'dogProfile': getDoc(['dogs'], WorkoutRecord.fromSnapshot),
          },
          builder: (context, params) => EditWorkoutProfileWidget(
        ...
        FFRoute(
          ...
          builder: (context, params) => CreateWorkoutProfileNewWidget(),
        ),
        FFRoute(
          name: 'chatPage',
          path: '/chatPage',
