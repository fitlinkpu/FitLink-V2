...
abstract class FitLinkTheme {
  ...
  static FitLinkTheme of(BuildContext context) {
...
class LightModeTheme extends FitLinkTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
  ...
  late Color secondary = const Color(0xFF4E39F9);
...
class DarkModeTheme extends FitLinkTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
