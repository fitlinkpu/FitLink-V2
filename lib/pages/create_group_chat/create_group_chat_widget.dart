      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              'Create Group Chat',
              style: FitLinkTheme.of(context).titleMedium,
            ),
            Text(
            ...
            child: Padding(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  filled: true,
                  fillColor: FitLinkTheme.of(context).secondaryBackground,
                  contentPadding:
            ...
            child: Padding(
              ...
              child: FFButtonWidget(
                ...
                options: FFButtonOptions(
                  ...
                  color: Color(0xFF4E39F9),
                  textStyle: FitLinkTheme.of(context).headlineSmall.override(
