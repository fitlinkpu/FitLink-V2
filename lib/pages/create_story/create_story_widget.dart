...
class _CreateStoryWidgetState extends State<CreateStoryWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: scaffoldKey,
      backgroundColor: FitLinkTheme.of(context).primaryDark,
      body: SafeArea(
        top: true,
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          final selectedMedia =
                            ...
                            allowPhoto: true,
                            allowVideo: true,
                            backgroundColor: FitLinkTheme.of(context).dark600,
                            textColor: FitLinkTheme.of(context).tertiary,
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  gradient: LinearGradient(
                                    colors: [
                                      Colors.transparent,
                                      FitLinkTheme.of(context).primaryDark
                                    ],
                                    stops: [0.0, 1.0],
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      hintText: 'Comment....',
                                      hintStyle: FitLinkTheme.of(context)
                                          .bodySmall
                                          .override(
                                    ...
                                    style: FitLinkTheme.of(context)
                                        ...
                                        .override(
                                          fontFamily: 'Outfit',
                                          color:
                                              FitLinkTheme.of(context).tertiary,
                                          fontSize: 14.0,
                                          fontWeight: FontWeight.normal,
                                        ),
                              ...
                              Text(
                                ...
                                style: FitLinkTheme.of(context)
                                    ...
                                    .override(
                                      fontFamily: 'Urbanist',
                                      color:
                                          FitLinkTheme.of(context).background,
                                      fontSize: 12.0,
                                    ),
                              ),
                            ],
