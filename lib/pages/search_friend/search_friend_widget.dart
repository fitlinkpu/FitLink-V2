...
import 'search_friend_model.dart';
export 'search_friend_model.dart';
...
class _SearchFriendWidgetState extends State<SearchFriendWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchFriendModel());
  }
          ...
          title: Column(
            ...
            children: [
              Text(
                ...
                style: FitLinkTheme.of(context).headlineSmall.override(
                      fontFamily: 'Urbanist',
                      fontSize: 25.0,
                    ),
              ),
              Text(
                'Click to open Users Profile',
                style: FitLinkTheme.of(context).labelMedium.override(
                      fontFamily: 'Urbanist',
                      fontSize: 15.0,
                    ),
              ),
          ...
          actions: [
            Padding(
              ...
              child: FlutterFlowIconButton(
                ...
                borderWidth: 1.0,
                buttonSize: 44.0,
                fillColor: FitLinkTheme.of(context).alternate,
                icon: Icon(
                  Icons.close_rounded,
