...
import 'create_workout_profile_model.dart';
export 'create_workout_profile_model.dart';

class CreateWorkoutProfileWidget extends StatefulWidget {
  const CreateWorkoutProfileWidget({Key? key}) : super(key: key);

  @override
  _CreateWorkoutProfileWidgetState createState() =>
      _CreateWorkoutProfileWidgetState();
}

class _CreateWorkoutProfileWidgetState
    extends State<CreateWorkoutProfileWidget> {
  late CreateWorkoutProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateWorkoutProfileModel());
                          ...
                          child: FFButtonWidget(
                            ...
                            options: FFButtonOptions(
                              ...
                              iconPadding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 0.0),
                              color: FitLinkTheme.of(context).background,
                              textStyle: FitLinkTheme.of(context)
                                  .titleSmall
                                  .override(
                                    fontFamily: 'Urbanist',
                                    color: FitLinkTheme.of(context).primaryDark,
                                  ),
                              elevation: 0.0,
                              borderSide: BorderSide(
                            ...
                            onPressed: () async {
                              await WorkoutRecord.collection
                                  ...
                                  .set(createDogsRecordData(
                                    ...
                                    dogName: '',
                                    dogType: _model.dogNameController.text,
