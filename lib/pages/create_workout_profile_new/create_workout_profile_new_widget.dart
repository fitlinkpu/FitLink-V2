...
import 'create_workout_profile_new_model.dart';
export 'create_workout_profile_new_model.dart';

class CreateWorkoutProfileNewWidget extends StatefulWidget {
  const CreateWorkoutProfileNewWidget({Key? key}) : super(key: key);

  @override
  _CreateWorkoutProfileNewWidgetState createState() =>
      _CreateWorkoutProfileNewWidgetState();
}

class _CreateWorkoutProfileNewWidgetState
    extends State<CreateWorkoutProfileNewWidget> {
  late CreateWorkoutProfileNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateWorkoutProfileNewModel());
      ...
      appBar: AppBar(
        ...
        actions: [
          FlutterFlowIconButton(
            ...
            icon: Icon(
              Icons.close_rounded,
              color: FitLinkTheme.of(context).secondaryText,
              size: 30.0,
            ),
            onPressed: () async {
              context.pop();
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      ...
                      options: FFButtonOptions(
                        ...
                        textStyle: FitLinkTheme.of(context).titleSmall.override(
                              fontFamily: 'Urbanist',
                              color: Colors.white,
                            ),
                        elevation: 2.0,
