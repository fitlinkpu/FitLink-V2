...
export 'change_picture_model.dart';

class ChangePictureWidget extends StatefulWidget {
  const ChangePictureWidget({Key? key}) : super(key: key);

  @override
  _ChangePictureWidgetState createState() => _ChangePictureWidgetState();
}
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: Text(
                                  'Change Photo',
                                  style:
                                      FitLinkTheme.of(context).headlineMedium,
                                ),
                              ),
                            ),
                          ],
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: Text(
                                  ...
                                  style: FitLinkTheme.of(context).labelMedium,
                                ),
                              ),
                            ),
                          ],
                              ...
                              FFButtonWidget(
                                ...
                                options: FFButtonOptions(
                                  ...
                                  color: FitLinkTheme.of(context)
                                      .primaryBackground,
                                  textStyle:
                                      FitLinkTheme.of(context).labelMedium,
                                  elevation: 2.0,
